# Zeus Engine
A graphics engine built with Rust and Vulkan API.

## Documents
- [gfx-rs](https://docs.rs/gfx-hal/0.4.1/gfx_hal)
- [winit](https://docs.rs/winit/0.20.0/winit)
- [freetype-rs](https://docs.rs/crate/freetype-rs/0.23.0)
- [env-logger](https://docs.rs/env_logger/0.7.1/env_logger)
- [log](https://docs.rs/log/0.4.10/log/)
- [glsl-to-spriv](https://docs.rs/glsl-to-spirv/0.1.7/glsl_to_spirv/)
...
- [Rendering lots of objects](https://gamedev.stackexchange.com/questions/144988/vulkan-rendering-lots-of-objects)
- [C++ Vulkan Demos](https://github.com/Z80Fan/VulkanDemos)
- [Render different objects](https://www.reddit.com/r/vulkan/comments/emlskf/how_to_render_2_sets_of_geometry_to_the_same/)
- [Vange-rs Blog](https://kvark.github.io/vange-rs/)
